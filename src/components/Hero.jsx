...
export default function Hero() {
    ...
    return (
        ...
        >
            ...
            {/* ── Sicily SVG — large central background silhouette ── */}
            <div className="absolute inset-0 pointer-events-none flex items-center justify-center" style={{ top: '60px' }}>
                <svg
                    viewBox="0 0 900 520"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                    style={{ width: 'min(88vw, 780px)', opacity: 0.055, filter: 'blur(0.5px)' }}
                >
                    {/* Outer glow */}
                    <ellipse cx="450" cy="270" rx="400" ry="230" fill="rgba(212,168,83,0.15)" />
                    {/* Sicily island silhouette — detailed path */}
                    <path
                        d="M 70 290
                           C 55 275 40 258 48 240
                           C 56 222 74 218 88 208
                           C 102 198 108 182 120 170
                           C 132 158 148 152 162 142
                           C 176 132 184 116 198 106
                           C 212 96 228 96 242 88
                           C 256 80 268 68 284 60
                           C 300 52 316 52 332 46
                           C 348 40 362 28 378 24
                           C 394 20 410 24 426 22
                           C 442 20 456 12 472 10
                           C 488 8 504 14 520 16
                           C 536 18 550 14 566 18
                           C 582 22 594 34 608 42
                           C 622 50 636 56 648 66
                           C 660 76 668 90 678 102
                           C 688 114 700 124 710 136
                           C 720 148 726 162 734 176
                           C 742 190 752 202 758 216
                           C 764 230 764 246 768 260
                           C 772 274 778 288 778 302
                           C 778 316 772 330 764 342
                           C 756 354 744 362 732 370
                           C 720 378 706 382 692 388
                           C 678 394 664 398 650 402
                           C 636 406 620 406 606 410
                           C 592 414 580 422 566 424
                           C 552 426 538 422 524 424
                           C 510 426 498 434 484 436
                           C 470 438 456 434 442 436
                           C 428 438 416 446 402 446
                           C 388 446 374 440 360 438
                           C 346 436 332 440 318 438
                           C 304 436 292 428 278 424
                           C 264 420 250 420 236 414
                           C 222 408 210 398 196 390
                           C 182 382 168 376 156 366
                           C 144 356 134 344 122 332
                           C 110 320 98 308 86 298 Z"
                        fill="rgba(212,168,83,0.9)"
                        stroke="rgba(212,168,83,0.4)"
                        strokeWidth="1.5"
                    />
                    {/* Etna volcano */}
                    <path d="M 190 168 L 204 138 L 220 168 Z" fill="rgba(212,168,83,0.7)" />
                    {/* Province of Ragusa marker dot */}
                    <circle cx="560" cy="360" r="10" fill="rgba(212,168,83,0)" stroke="rgba(212,168,83,0.8)" strokeWidth="2" />
                    <circle cx="560" cy="360" r="4" fill="rgba(212,168,83,0.9)" />
                    {/* Ragusa label */}
                    <text x="576" y="364" fontSize="11" fill="rgba(212,168,83,0.7)" fontFamily="monospace" letterSpacing="1">Ragusa</text>
                    {/* Dotted coastline hints */}
                    <circle cx="300" cy="430" r="2.5" fill="rgba(100,180,255,0.5)" />
                    <circle cx="440" cy="445" r="2" fill="rgba(100,180,255,0.4)" />
                    <circle cx="560" cy="430" r="2.5" fill="rgba(100,180,255,0.5)" />
                    <circle cx="660" cy="400" r="2" fill="rgba(100,180,255,0.4)" />
                    {/* Circuit lines on province roads */}
                    <line x1="400" y1="300" x2="560" y2="360" stroke="rgba(212,168,83,0.12)" strokeWidth="1" strokeDasharray="4 6" />
                    <line x1="350" y1="320" x2="560" y2="360" stroke="rgba(212,168,83,0.10)" strokeWidth="1" strokeDasharray="4 6" />
                    <line x1="560" y1="360" x2="650" y2="380" stroke="rgba(212,168,83,0.12)" strokeWidth="1" strokeDasharray="4 6" />
                </svg>
            </div>
