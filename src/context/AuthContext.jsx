...
export function AuthProvider({ children }) {
    ...
    async function fetchProfile(authUser) {
        ...
        const { data, error } = await supabase
            .from('profiles')
            .select('id, name, role, employment_type, profession, vat_number, company_name, company_role, stats_metadata, onboarded, stripe_account_id, stripe_onboarding_complete, stripe_charges_enabled')
            .eq('id', authUser.id)
            .single();
